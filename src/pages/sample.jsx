...
<div className='button_Container'>
  ...
  {!StartPlaying && videoReady && (
    <div className="bg-container">
      <div className="time-holder-wrapper">
        <img
          src="/assets/TimeHolder.png"
          alt="divider"
          className="time-holder-img"
        />
        <div className="time-left">
          {formatTime(gameDuration)}s Left
        </div>
      </div>
      ...
      {StartPlaying && (
        <div className="start-playing-button">
          <button
            onClick={StartQueue}
            style={{ backgroundImage: "url('/assets/Startplaying.png')" }}
          />
        </div>
      )}
      ...
      {failScreen && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="relative">
            <img
              src="/assets/FailPopUp.png"
              alt="Win Popup"
              className="max-w-xs drop-shadow-2xl"
            />
            <button
               onClick={()=>ResetForPlay(false)}
